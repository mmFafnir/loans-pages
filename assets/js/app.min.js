...
/* harmony import */ var _range_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./range.js */ "./src/assets/js/modules/range.js");
...
window.addEventListener('resize', () => {
    ...
    if(_range_js__WEBPACK_IMPORTED_MODULE_1__.rangesClass && _range_js__WEBPACK_IMPORTED_MODULE_1__.rangesClass.length > 0) {
        _range_js__WEBPACK_IMPORTED_MODULE_1__.rangesClass.forEach(range => {
            range.updateSlider()
        })
    }
})
...
class Accordion {
    constructor(accordion) {
        ...
        this.title = accordion.querySelector('.accordion-item__title') || accordion.querySelector('.acc-title');
        this.body = accordion.querySelector('.accordion-item__body') || accordion.querySelector('.acc-body');
        this.init()
    }
    ...
    _changeCite() {
        this.citiesList.forEach(input => {
            ...
            input.addEventListener('input', () => {
                if(input.checked) {
                    this.searchInput.value = input.previousElementSibling.textContent;
                    console.log(selectClasses[1].accordion)
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_resizeTextArea_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/resizeTextArea.js */ "./src/assets/js/modules/utils/resizeTextArea.js");
...
textareaList.forEach((textarea) => {
    textarea.addEventListener('input', _utils_resizeTextArea_js__WEBPACK_IMPORTED_MODULE_0__.resizeTextArea);
})
...
const openNewLogo = () => {
  if(window.innerWidth > 700 || !firstScreen) return;

  if(scrollPosition() > firstScreen.scrollTop + firstScreen.clientHeight) {
        ...
        links.forEach(link => {
            ...
            link.addEventListener('click', (e) => {
                ...
                if(document.querySelector('.modal.show') !== modal) {
                    document.querySelector('.modal.show')?.classList.add('loading');
...
const openModalBtnFixed = () => {
    const link = document.querySelector('.btn-fixed');
    if(!link) return;
    link.style.transform = `translateX(-${(0,_utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__.getScrollBarWidth)()}px)`
}

const closeModalBtnFixed = () => {
    const link = document.querySelector('.btn-fixed');
    if(!link) return;
...
// var uuidCookie = runnerGetCookie('uuid'); var uuid = ('0' == '0') ? '944FF0DB76E742608AE2C1787ED202A9' : (typeof uuidCookie == 'undefined' || !uuidCookie || uuidCookie == '') ? '944FF0DB76E742608AE2C1787ED202A9' : uuidCookie;
// var ppvCookie = runnerGetCookie('ppv'); var ppv = (typeof ppvCookie == 'undefined' || !ppvCookie || ppvCookie == '') ? '0' : ppvCookie;
// document.write("<scr"+"ipt id='omFormScript-944FF0DB76E742608AE2C1787ED202A9' type='text/javascr"+"ipt' src='https://cdn101.zeroparallel.com/form/loader.php?orig_p=944FF0DB76E742608AE2C1787ED202A9&p=" + uuid + "&ppv=" + ppv + "&site="+document.location.origin+"&queryString="+encodeURIComponent(document.location.search)+"'></scr"+"ipt>");
 
// const staticOffsetTop = () => {
//     const posTop = window.pageYOffset || document.documentElement.scrollTop;
//     setTimeout(() => document.documentElement.scrollTop = posTop, 320)
// }

// const setTemplateFrame = () => {
//     const popupGet = document.querySelector('#popup-get');
//     if(!popupGet) return; 
//     const payForm = document.querySelector('#omForm-root') || '';
//     const content = popupGet.querySelector('.modal__content');
...
//         setTimeout(() => {
//             if(!payFormBtnNext) {
//                 payFormBtnNext = payForm.querySelector('.om-navigation__Next');
//                 payFormBtnPrev.addEventListener('click', () => {
//                     prevClickBtn()
//                 })
//             }
//             if(!payForm.querySelector('.om-navigation__prev')) {
//                 payFormBtnPrev = null;
//             }
//         }, 340)
//     }
...
//         setTimeout(() => {
//             if(!payFormBtnPrev) {
//                 payFormBtnPrev = payForm.querySelector('.om-navigation__prev');
//                 payFormBtnPrev.addEventListener('click', () => {
//                     prevClickBtn()
//                 })
//             }
//             if(!payForm.querySelector('.om-navigation__next')) {
//                 payFormBtnPrev = null;
//             }
//         }, 340)
//     }
...
//     content.insertAdjacentElement('beforeend', payForm);

//     payForm.addEventListener('click', (e) => {
        
//         if(e.target.closest('.om-navigation__prev') || e.target.closest('.om-navigation__next') || e.target.closest('.div-select__item')) {
//             staticOffsetTop()
//         }
//     })    
    
//     // let payFormBtnPrev = payForm.querySelector('.om-navigation__prev') || null;
//     // let payFormBtnNext = payForm.querySelector('.om-navigation__next') || null;
...
//     // if(payFormBtnNext) {
//     //     payFormBtnNext.addEventListener('click', () => {
//     //         nextClickBtn()
//     //     })
//     // }
// }
...
// document.body.insertAdjacentElement('beforeend', doc)
...
class Range {
  constructor(range) {
    ...
    this.value = this.slider.dataset.start ? Number(this.slider.dataset.start) : 0;
    this._init()
  }
  _init(){
      ...
      if(this.buttonCheck) {
        ...
        this.buttonCheck.addEventListener('input', (e) => this._onCheckRange(e.target.checked))  
      }
  ...
  _setThumb(val){
    let newx = `calc(${(this.slider.offsetWidth-55) * val/100}px - ${0}px)`;
    console.log(newx)
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/header.js */ "./src/assets/js/modules/header.js");
/* harmony import */ var _modules_accordion_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/accordion.js */ "./src/assets/js/modules/accordion.js");
...
/* harmony import */ var _modules_range_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/range.js */ "./src/assets/js/modules/range.js");
/* harmony import */ var _modules_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal.js */ "./src/assets/js/modules/modal.js");
/* harmony import */ var _modules_cities_select_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cities-select.js */ "./src/assets/js/modules/cities-select.js");
/* harmony import */ var _modules_adaptiveBlock_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/adaptiveBlock.js */ "./src/assets/js/modules/adaptiveBlock.js");
/* harmony import */ var _modules_animate_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/animate.js */ "./src/assets/js/modules/animate.js");
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/form.js */ "./src/assets/js/modules/form.js");
/* harmony import */ var _modules_cookies_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/cookies.js */ "./src/assets/js/modules/cookies.js");
/* harmony import */ var _modules_popup_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/popup.js */ "./src/assets/js/modules/popup.js");
/* harmony import */ var _modules_DocumentEvents_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/DocumentEvents.js */ "./src/assets/js/modules/DocumentEvents.js");
