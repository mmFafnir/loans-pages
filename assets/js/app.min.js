...
/***/ "./src/assets/js/modules/DocumentEvents.js":
/*!*************************************************!*\
  !*** ./src/assets/js/modules/DocumentEvents.js ***!
  \*************************************************/
...
/* harmony import */ var _adaptiveBlock_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./adaptiveBlock.js */ "./src/assets/js/modules/adaptiveBlock.js");
/* harmony import */ var _masonry_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./masonry.js */ "./src/assets/js/modules/masonry.js");
/* harmony import */ var _range_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./range.js */ "./src/assets/js/modules/range.js");
...
window.addEventListener("resize", () => {
  if (_adaptiveBlock_js__WEBPACK_IMPORTED_MODULE_0__.adaptiveDivArr.length > 0) {
    _adaptiveBlock_js__WEBPACK_IMPORTED_MODULE_0__.adaptiveDivArr.forEach((adapt) => {
      adapt.resize();
    });
  }

  _masonry_js__WEBPACK_IMPORTED_MODULE_1__.masonryClasses.forEach((masonry) => {
    masonry.resize();
  });

  if (window.innerWidth > 1025 && burgerMenu.classList.contains("show")) {
    burgerMenu.classList.remove("show");
    document
      .querySelector(".modal-link-active")
      ?.classList.remove("modal-link-active");
    document.body.classList.remove("lock");
    document.body.removeAttribute("style");
  }
  if (_range_js__WEBPACK_IMPORTED_MODULE_2__.rangesClass && _range_js__WEBPACK_IMPORTED_MODULE_2__.rangesClass.length > 0) {
    _range_js__WEBPACK_IMPORTED_MODULE_2__.rangesClass.forEach((range) => {
      range.updateSlider();
    });
  }
});
...
class Accordion {
  constructor(accordion) {
    ...
    this.title =
      accordion.querySelector(".accordion-item__title") ||
      accordion.querySelector(".acc-title");
    this.body =
      accordion.querySelector(".accordion-item__body") ||
      accordion.querySelector(".acc-body");
  }

  init() {
    if (this.title.querySelector("input")) {
      const input = this.title.querySelector("input");
      const openBtn = this.title.querySelector(".icon");
      if (input) {
  ...
  _toggleClickHandler() {
    ...
    this.accordion.classList.toggle("active-main");
    this.openBody();
  }
  ...
  _openClickHandler() {
    ...
    this.accordion.classList.add("active-main");
  ...
  openBody() {
    if (this.body.classList.contains("active")) {
      this.body.style.height = this.body.children[0].clientHeight + "px";
    } else {
...
if (accordionItems.length > 0) {
  accordionItems.forEach((acc) => {
    const AccClass = new Accordion(acc);
    AccClass.init();
  });
}

class TextMore extends Accordion {
  constructor(block) {
    super(block);
    this.title = block.querySelector(".text-more-title");
    this.body = block.querySelector(".text-more-body");
    this.shadow = block.querySelector(".shadow");
    if (this.body.children[0].clientHeight <= this.body.clientHeight) {
  ...
  openBody() {
    if (this.body.classList.contains("active")) {
      this.body.style.maxHeight = this.body.children[0].clientHeight + "px";
      this.title.children[0].textContent = "Hide";
      if (this.shadow) {
        this.shadow.style.display = "none";
      }
    } else {
      this.body.removeAttribute("style");
      this.title.children[0].textContent = "Show more";
      if (this.shadow) {
...
window.addEventListener("load", function () {
  const textMoreBlocks = document.querySelectorAll(".text-more-block");

  if (textMoreBlocks.length > 0) {
    textMoreBlocks.forEach((block) => {
      const TextBlockClass = new TextMore(block);
      TextBlockClass.init();
    });
  }
});
...
/***/ "./src/assets/js/modules/adaptiveBlock.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/adaptiveBlock.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AdaptiveBlock: () => (/* binding */ AdaptiveBlock),
/* harmony export */   adaptiveDivArr: () => (/* binding */ adaptiveDivArr)
/* harmony export */ });
...
class AdaptiveBlock {
    constructor(div) {
        ...
        this.div = div;
        this.parent = this.div.parentElement;
        this.toDiv = document.querySelector(this.div.dataset.to);
        this.pos = this.div.dataset.pos;
        this.maxWidth = Number(this.div.dataset.width); 
        this.resize()
    ...
    resize() {
        if(this.maxWidth >= window.innerWidth) {
            if(!this.adaptive) {
                this.changePosDiv(this.toDiv, this.pos, this.div);
                this.adaptive = true;
            }        
        } else {
            if(this.adaptive) {
                this.changePosDiv(this.parent, 'beforeend', this.div);
                this.adaptive = false;
            }
        }
    }

    changePosDiv(to, pos, div) {
        to.insertAdjacentElement(pos, div)
    }
}



const adaptiveBlock = document.querySelectorAll('.adaptive-block');
const adaptiveDivArr = []
if(adaptiveBlock.length > 0) {
    adaptiveBlock.forEach(div => {
        const adaptiveDiv = new AdaptiveBlock(div);
        adaptiveDivArr.push(adaptiveDiv)
    })
}
...
/***/ "./src/assets/js/modules/animate.js":
/*!******************************************!*\
  !*** ./src/assets/js/modules/animate.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   ...
   function animOnScroll() {
      ...
      for (let index = 0; index < animItems.length; index++) {
         ...
         if ((pageYOffset > animItemOffset - animItemPoint)
            ...
            if (!animItem.closest('.__no-repeat-anim')) {
...
/***/ "./src/assets/js/modules/api/asyncGetFrom.js":
/*!***************************************************!*\
  !*** ./src/assets/js/modules/api/asyncGetFrom.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   asyncGetForm: () => (/* binding */ asyncGetForm)
/* harmony export */ });
const asyncGetForm = async () => {
  try {
    const response = await fetch("https://test.usacashlink.com/get_new_form");
...
/***/ "./src/assets/js/modules/api/asyncPostForm.js":
/*!****************************************************!*\
  !*** ./src/assets/js/modules/api/asyncPostForm.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   asyncPostForm: () => (/* binding */ asyncPostForm)
/* harmony export */ });
const asyncPostForm = async (params) => {
  try {
    let dataIp = await $.getJSON("https://api.ipify.org?format=json");
    const userAgent = navigator.userAgent;
    const response = await fetch(
      "https://test.usacashlink.com/api/test_send_api",
      {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          userAgent: userAgent,
          price: 0,
          incomeNextDate2: params.incomeNextDate1,
          webSiteUrl: "https://usacashlink.com/",
          workPhone: "888888888",
          workCompanyName: "benefits",
          ...params,
          incomeNetMonthly: params.incomeNetMonthly.replace(/\D+/g, ""),
        }),
      }
    );
    const data = await response.json();
...
/***/ "./src/assets/js/modules/cities-select.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/cities-select.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _accordion_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordion.js */ "./src/assets/js/modules/accordion.js");


class SearchCities {
  constructor(element) {
    this.element = element;
    this.title = this.element.querySelector(".cities-select__title");
    this.body = this.element.querySelector(".cities-select__body");
    this.searchInput = this.title.querySelector("input");
    this.citiesList = this.body.querySelectorAll("input");
    this.init();
  }

  init() {
    this.accordion = new _accordion_js__WEBPACK_IMPORTED_MODULE_0__.Accordion(this.element);
    this._changeCite();
    this._searchCite();
  }
  ...
  _searchCite() {
    ...
    this.searchInput.addEventListener("input", (e) => {
      ...
      this.citiesList.forEach((cite) => {
        if (value.trim().length === 0) {
          cite.parentElement.style.display = "flex";
          findCities.push(cite);
          return;
        }
        if (cite.value.toLowerCase().includes(value.trim())) {
          cite.parentElement.style.display = "flex";
          findCities.push(cite);
        } else {
          cite.parentElement.style.display = "none";
          findCities.filter((prev) => prev !== cite);
        }
      });
      if (findCities.length === 0) {
        setTimeout(() => {
          this.body.children[0]?.insertAdjacentElement("beforeend", empty);
        }, 100);
      } else {
        empty.remove();
      }
      setTimeout(() => {
        this.accordion.openBody();
      }, 100);
    });
  }

  _changeCite() {
    this.citiesList.forEach((input) => {
      if (input.checked) {
        this.searchInput.value = input.previousElementSibling.textContent;
      }
      input.addEventListener("input", () => {
        if (input.checked) {
          this.searchInput.value = input.previousElementSibling.textContent;
          selectClasses[1].accordion._openClickHandler();
        }
      });
    });
  }
...
const selectCities = document.querySelectorAll(".cities-select");

var selectClasses = [];
if (selectCities.length > 0) {
  selectCities.forEach((select) => {
    selectClasses.push(new SearchCities(select));
  });
}
...
/***/ "./src/assets/js/modules/classes/FormSlider.js":
/*!*****************************************************!*\
  !*** ./src/assets/js/modules/classes/FormSlider.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/localStorage.js */ "./src/assets/js/modules/utils/localStorage.js");
/* harmony import */ var _api_asyncPostForm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api/asyncPostForm.js */ "./src/assets/js/modules/api/asyncPostForm.js");
/* harmony import */ var _Validation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Validation.js */ "./src/assets/js/modules/classes/Validation.js");
/* harmony import */ var _utils_getFormValues_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/getFormValues.js */ "./src/assets/js/modules/utils/getFormValues.js");
...
class FormSlider {
  constructor(form) {
    this.form = form;
    this.progressBar = form.querySelector(".progress-bar");
    this.submitBtn = form.querySelector("button[type=submit]");
    this.btnNext = this.form.querySelector(".form-get-nav__next");
    this.validate = new _Validation_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this.inputs = form.querySelectorAll("input");

    const slider = form.querySelector(".swiper");
   
    this.setDefaultValues();
    this._initSwiper(slider);
    this._eventBtn();
  }
  ...
  _initSwiper(slider) {
    ...
    this.swiper = new Swiper(slider, {
      ...
      on: {
        slideChange: (swiper) => {
          this._progressChange(swiper);
          this._validationSlideInputs(swiper.slides[swiper.activeIndex]);
          this._toggleSubmitShow(swiper);
          this.saveValues()
        },
        init: (swiper) => {
          this._progressChange(swiper);
  ...
  _progressChange(swiper) {
    if (!this.progressBar) return;
    const value = ((swiper.activeIndex + 1) / swiper.slides.length) * 100;

    this.progressBar.querySelector(".progress-bar__value").textContent =
      Math.floor(value) + "%";
    this.progressBar.querySelector(".progress-bar__slider span").style.width =
      value + "%";
  }

  _validationSlideInputs(slide) {
    this.validate.start(slide.querySelectorAll("input"));
  }
  ...
  _eventBtn() {
    this.btnNext.addEventListener("click", () => {
      ...
      this.validate.checkValid(inputs);

      if (!slide.querySelector(".error")) {
  ...
  _submitData() {
    ...
    const data = (0,_utils_getFormValues_js__WEBPACK_IMPORTED_MODULE_3__.getFormValues)(this.form);
    (0,_api_asyncPostForm_js__WEBPACK_IMPORTED_MODULE_1__.asyncPostForm)(data)
      .then((res) => {
        if (res.message.status_text === "reject") {
          const modalBtn = document.querySelector(
            'a[href*="#modal/modal-reject"]'
          );
          if (!modalBtn) return;
          modalBtn.click();
        }
        if (res.message.status_text === "success") {
          (0,_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.removeLocalStorage)(_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.KeyLS.FORM_VALUES);
          console.log(res);
        }
      })
      .finally(() => {
  ...
  setDefaultValues() {
    const defaultValues = (0,_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.getLocalStorage)(_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.KeyLS.FORM_VALUES);
  ...
  saveValues() {
    const data = (0,_utils_getFormValues_js__WEBPACK_IMPORTED_MODULE_3__.getFormValues)(this.form);
    (0,_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.setLocalStorage)(_utils_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.KeyLS.FORM_VALUES, data);
  }
}
...
/***/ "./src/assets/js/modules/classes/Validation.js":
/*!*****************************************************!*\
  !*** ./src/assets/js/modules/classes/Validation.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
class Validation {
  constructor() {
    const dependentDivs = document.querySelectorAll(".ui-div-dependent");
    this.dependentDivs = [];
    dependentDivs.forEach((div) => {
      this.dependentDivs.push({
        parent: div.parentElement,
        div: div,
        depend: div.dataset.depend,
      });
      div.remove();
    });
  }
  ...
  _addInputParams(input) {
    if (input.dataset.mask) this._mask(input);
    if (input.classList.contains("price")) this._maskPrice(input);
    if (input.type == "radio") this._dependentCheck(input);
  }

  _validInput(input) {
    if (input.required) this._required(input);
    if (input.classList.contains("no-weekend")) this._noWeekend(input);
    if (input.type == "radio") this._dependentCheck(input);
    if (input.classList.contains("no-numbers")) this._noNumbers(input);
    if (input.classList.contains("phone")) this._validPhoneNumbers(input);
    if (input.dataset.pattern) this._pattern(input.dataset.pattern, input);
    this._length(input.dataset.minlength, input.dataset.maxlength, input);
    this._sum(input.dataset.min, input.dataset.max, input);
  }

  _mask(input) {
    const mask = input.dataset.mask;
    const newMask = new IMask(input, {
      mask: mask,
    });
  }
  ...
  _pattern(reg, input) {
    ...
    const success = regex.test(input.value);
    if (!success) this._setError(input);
    if (success) this._setSuccess(input);
  }

  _length(min, max, input) {
    if (!min && !max) return;
    const minCondition = input.dataset.mask
      ? input.value.replace(/\D+/g, "").length < min
      : input.value.length < min;
    if (minCondition) {
      this._setErrorMassage(`Field may not be less than ${min} letters`, input);
      this._setError(input);
      return;
    }
    if (input.value.length > max) {
      this._setErrorMassage(`Field may not be more than ${max} letters`, input);
      this._setError(input);
      return;
    }
  ...
  _required(input) {
    if (input.value.trim().length > 0) return this._setSuccess(input);
    this._setErrorMassage("Required field", input);
    this._setError(input);
  }

  _setError(input) {
    input.closest(".ui-input").classList.remove("success");
    input.closest(".ui-input").classList.add("error");
  }

  _setErrorMassage(massage, input) {
    const errorSpan = input.closest(".ui-input").querySelector(".ui-error");
    if (!errorSpan) return;
    errorSpan.textContent = massage;
  }

  _setSuccess(input) {
    input.closest(".ui-input").classList.remove("error");
    input.closest(".ui-input").classList.add("success");
  }
  ...
  _dependentCheck(input) {
    const findDivDepend = this.dependentDivs.filter(
      (div) => div.depend === input.name
    );
    if (!input.checked || findDivDepend.length == 0) return;

    this.dependentDivs.forEach(({ parent, div }) => {
      if (div.dataset.show.includes(input.value)) {
        parent.innerHTML = "";
        parent.insertAdjacentElement("beforeend", div);
        div.querySelectorAll("input").forEach((divInput) => {
          this.validate(divInput);
        });
      } else {
        div.remove();
      }
  ...
  _noWeekend(input) {
    ...
    if ([6, 0].includes(day) || input.value.trim().length === 0) {
      this._setError(input);
      return;
    }
    this._setSuccess(input);
...
/***/ "./src/assets/js/modules/cookies.js":
/*!******************************************!*\
  !*** ./src/assets/js/modules/cookies.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if(cookies) {
    const btns = cookies.querySelectorAll('.btn');
    btns.forEach((btn) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_asyncGetFrom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/asyncGetFrom.js */ "./src/assets/js/modules/api/asyncGetFrom.js");
/* harmony import */ var _classes_FormSlider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/FormSlider.js */ "./src/assets/js/modules/classes/FormSlider.js");
/* harmony import */ var _utils_resizeTextArea_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/resizeTextArea.js */ "./src/assets/js/modules/utils/resizeTextArea.js");




const textareaList = document.querySelectorAll(".textarea-resize");

textareaList.forEach((textarea) => {
  textarea.addEventListener("input", _utils_resizeTextArea_js__WEBPACK_IMPORTED_MODULE_2__.resizeTextArea);
});

const modalOpenBtns = document.querySelectorAll('a[href*="#modal/popup-get"]');
const modalFormGet = document.querySelector(".modal-get");
if (modalFormGet) {
  const content = modalFormGet.querySelector(".modal-get__form");
  modalOpenBtns.forEach((btn) => {
    btn.addEventListener("click", (e) => {
      if(content.querySelector('.form-get')) return;
      modalFormGet.classList.add('loading');
      (0,_api_asyncGetFrom_js__WEBPACK_IMPORTED_MODULE_0__.asyncGetForm)().then((res) => {
        if (res === "error") return;
        content.innerHTML = res.data;
        const formSlider = new _classes_FormSlider_js__WEBPACK_IMPORTED_MODULE_1__.FormSlider(content.querySelector('.form-get'));
        modalFormGet.classList.remove('loading');
      });
    });
  });
  ...
  if(formGet) {
    const formSlider = new _classes_FormSlider_js__WEBPACK_IMPORTED_MODULE_1__.FormSlider(formGet);
  }
}
...
const headerMobBtn = header.querySelector(".header__btn-mob");
...
const openNewLogo = () => {
  if (
    ...
    (pathname.includes("contact-us") || pathname.includes("team"))
  )
    return;
    
  const startPos = firstScreen
    ? firstScreen.scrollTop + firstScreen.clientHeight
    : 100;

  if (scrollPosition() > startPos) {
    header.classList.add("new-header-fixed");
  } else {
    header.classList.remove("new-header-fixed");
  }
};
...
/***/ "./src/assets/js/modules/lazy-loading.js":
/*!***********************************************!*\
  !*** ./src/assets/js/modules/lazy-loading.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
$(function () {
  $(".lazy-block img").Lazy({
    beforeLoad: function (element) {
      ...
      img.closest(".lazy-block").classList.add("loading");
      img.insertAdjacentHTML("afterend", '<p class="loader"></p>');
    },
    afterLoad: function (element) {
      const img = element[0];
      img.style.display = "block";
      img.closest(".lazy-block").classList.remove("loading");
      setTimeout(() => {
...
/***/ "./src/assets/js/modules/masonry.js":
/*!******************************************!*\
  !*** ./src/assets/js/modules/masonry.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   masonryClasses: () => (/* binding */ masonryClasses)
/* harmony export */ });
class Masonry {
  constructor(masonry) {
    this.masonry = masonry;
    this.destroyWidth = this.masonry.dataset.destroyWidth;

    const itemSelector = this.masonry.dataset.itemSelector;
    const columnWidth = this.masonry.dataset.columnWidth;
  ...
  init() {
    $(this.masonry).masonry(this.masonryOptions);
  }
  ...
  resize() {
    if (window.innerWidth < Number(this.destroyWidth)) {
      this.destroy();
    } else {
      this.init();
    }
...
const masonryBlocks = document.querySelectorAll(".masonry");
const masonryClasses = [];
masonryBlocks.forEach((block) => {
  const masonry = new Masonry(block);
  masonryClasses.push(masonry);
});
...
/* harmony export */ });
/* harmony import */ var _utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/getScrollBarWidth.js */ "./src/assets/js/modules/utils/getScrollBarWidth.js");
...
if(modals.length > 0) {
    modals.forEach(modal => {
        const links = Array.from(modalLinks).filter(link => modal.id === link.hash.replace('#modal/', ''));

        modal.addEventListener('click', (e) => {
            const target = e.target;
            if(target.closest('.modal-close') || target.classList.contains('modal')) {
                modal.classList.remove('show')
                modal.removeAttribute('style');
                document.body.classList.remove('lock');
                document.body.removeAttribute('style');
                document.querySelector(`.modal-link-active`)?.classList.remove('modal-link-active')
        ...
        links.forEach(link => {
            ...
            link.addEventListener('click', (e) => {
                ...
                link.classList.toggle('modal-link-active');
                if(modal.classList.contains('show')){
                    window.history.pushState(
                        "", 
                        document.title, 
                        window.location.href.replace(/\#(.+)/, '').replace(/http(s?)\:\/\/([^\/]+)/, '')
                    )
    
                    document.body.classList.add('lock');
                    document.body.style.paddingRight = (0,_utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__.getScrollBarWidth)() + 'px';
                    modal.style.paddingRight = (0,_utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__.getScrollBarWidth)() + 'px';
                    header.classList.add('modal-open');

                    if(header.getBoundingClientRect().top < -120) {
                        modal.classList.add('no-header');
                    } else {
                        modal.classList.remove('no-header');
                    }
...
//   document.write(
//     "<scr" +
//       'ipt>function runnerGetCookie(name) { var searchUrl = new RegExp("[?&]" + name + "=([^&#]*)", "i"); var results = searchUrl.exec(document.location.search); var value = "; " + document.cookie; if (results !== null) { return decodeURIComponent(results[1].replace(/\\+/g, " ")); } var parts = value.split("; " + name + "="); if (parts.length >= 2) { return parts.pop().split(";").shift(); } }</scr' +
//       "ipt>"
//   );
//   var uuidCookie = runnerGetCookie("uuid");
//   var uuid =
//     "0" == "0"
//       ? "3E33D359BA3D4DA89E0E8E24C0A0CB9B"
//       : typeof uuidCookie == "undefined" || !uuidCookie || uuidCookie == ""
//       ? "3E33D359BA3D4DA89E0E8E24C0A0CB9B"
//       : uuidCookie;
//   var ppvCookie = runnerGetCookie("ppv");
//   var ppv =
//     typeof ppvCookie == "undefined" || !ppvCookie || ppvCookie == ""
//       ? "0"
//       : ppvCookie;
//   document.write(
//     "<scr" +
//       "ipt id='omFormScript-3E33D359BA3D4DA89E0E8E24C0A0CB9B' type='text/javascr" +
//       "ipt' src='https://cdn101.zeroparallel.com/form/loader.php?orig_p=3E33D359BA3D4DA89E0E8E24C0A0CB9B&p=" +
//       uuid +
//       "&ppv=" +
//       ppv +
//       "&site=" +
...
// const formToPopup = () => {
//   const form = document.querySelector("#omForm-root");
//   const modalContent = document.querySelector("#popup-get .modal__content");
//   modalContent.insertAdjacentElement("beforeend", form);

//   form.addEventListener("click", (e) => {
//     const target = e.target;
//     if (
//       target.closest(".div-select__item") ||
//       target.closest(".div-select__item") ||
//       target.closest(".om-navigation__next ") ||
//       target.closest(".om-navigation__prev") ||
//       target.closest(".loan-request__edit") ||
//       target.closest(".om-navigation__submit")
//     ) {
//       disableScroll()
//       if(!target.closest(".om-navigation__submit")) {
//         setTimeout(() => {
//           enableScroll()
//         }, 400)
//       }
...
/***/ "./src/assets/js/modules/range.js":
/*!****************************************!*\
  !*** ./src/assets/js/modules/range.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   rangesClass: () => (/* binding */ rangesClass)
/* harmony export */ });
class Range {
  constructor(range) {
    this.range = range;
    this.slider = range.querySelector(".customrange");
    this.inputText = range.querySelector(".range-value");
    this.thumb = range.querySelector(".range-sliderthumb");
    this.sliderValue = range.querySelector(".slidervalue");
    this.notify = range.querySelector(".notify");
    this.buttonCheck = range.querySelector(".range-button input");
    this.min = Number(this.slider.getAttribute("min"));
    this.max = Number(this.slider.getAttribute("max"));
    this.arrayStep = this.slider.dataset.array?.split(",");
    this.value = this.slider.dataset.start
      ? Number(this.slider.dataset.start)
      : 0;
    this._init();
  }
  _init() {
    this.slider.addEventListener("input", (e) => this.updateSlider());
    if (this.buttonCheck) {
      this._onCheckRange(this.buttonCheck.checked);
      this.buttonCheck.addEventListener("input", (e) =>
        this._onCheckRange(e.target.checked)
      );
    }
  ...
  updateSlider() {
    ...
    let pc = ((this.value - this.min) / (this.max - this.min)) * 100;
    this._setThumb(pc);
    this._setValueInput(this.value);
    this._validationInputText(this.value);
  }

  _validationInputText(val) {
    if (val < this.min) {
  ...
  _setThumb(val) {
    let newx = `calc(${
      ((this.slider.offsetWidth - 55) * val) / 100
    }px - ${0}px)`;
    this.thumb.style.left = newx;
    let max = 100;
    let degrees = 360 * (val / max);
    let rotation = `rotate(${degrees}deg) translateY(-50%)`;
    this.thumb.style.transform = rotation;
  }

  _setValueInput(val) {
    if (!this.inputText) return;
    this.slider.setAttribute("data-value", this.arrayStep[val]);
    this.inputText.innerHTML = Number(this.arrayStep[val]);
  }

  _onCheckRange(checked) {
    if (checked) {
      this.buttonCheck.parentElement?.classList.add("active");
      this.range.classList.remove("default");
    } else {
      this.range.classList.add("default");
      this.buttonCheck.parentElement?.classList.remove("active");
    }
  }
}
...
window.onload = () => {
  ...
  if (ranges.length > 0) {
    ranges.forEach((range) => {
      rangesClass.push(new Range(range));
    });
  }
};
...
/***/ "./src/assets/js/modules/user-leave.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/user-leave.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('mouseleave', (e) => {
    if(getCookie('cookie-leave') == 'true' || getCookie('cookie') == true || document.querySelector('.modal-get.show')) return;
    if(!modalLeave || useModal) return;
    if(e.clientY < 10) {
        modalLeave.classList.add('show');
        document.body.classList.add('lock');
        document.body.style.paddingRight = (0,_utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__.getScrollBarWidth)() + 'px';
        modalLeave.style.paddingRight = (0,_utils_getScrollBarWidth_js__WEBPACK_IMPORTED_MODULE_0__.getScrollBarWidth)() + 'px';
        useModal = true;
    }
})
...
/***/ "./src/assets/js/modules/utils/getFormValues.js":
/*!******************************************************!*\
  !*** ./src/assets/js/modules/utils/getFormValues.js ***!
  \******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
const getFormValues = (form) => {
  ...
  for (var i = 0; i < formElements.length; i++) {
    switch (formElements[i].type) {
      case "text":
        results[formElements[i].name] = formElements[i].value;
        break;

      case "radio":
        if (!formElements[i].checked) break;
        results[formElements[i].name] = formElements[i].value;
        break;
      ...
      case "select-one":
        results[formElements[i].name] =
          formElements[i].options[formElements[i].selectedIndex].value;
        break;

      case "hidden":
        if (formElements[i].value.trim() == 0) break;
        results[formElements[i].name] = formElements[i].value;
        break
      ...
      // Добавьте больше случаев для других типов input, если это необходимо
      default:
        results[formElements[i].name] = formElements[i].value;
    }
  }
...
/***/ "./src/assets/js/modules/utils/getScrollBarWidth.js":
/*!**********************************************************!*\
  !*** ./src/assets/js/modules/utils/getScrollBarWidth.js ***!
  \**********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/assets/js/modules/utils/localStorage.js":
/*!*****************************************************!*\
  !*** ./src/assets/js/modules/utils/localStorage.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   KeyLS: () => (/* binding */ KeyLS),
...
/***/ "./src/assets/js/modules/utils/resizeTextArea.js":
/*!*******************************************************!*\
  !*** ./src/assets/js/modules/utils/resizeTextArea.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_lazy_loading_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/lazy-loading.js */ "./src/assets/js/modules/lazy-loading.js");
/* harmony import */ var _modules_popup_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/popup.js */ "./src/assets/js/modules/popup.js");
/* harmony import */ var _modules_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/header.js */ "./src/assets/js/modules/header.js");
...
/* harmony import */ var _modules_range_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/range.js */ "./src/assets/js/modules/range.js");
...
/* harmony import */ var _modules_cities_select_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cities-select.js */ "./src/assets/js/modules/cities-select.js");
/* harmony import */ var _modules_adaptiveBlock_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/adaptiveBlock.js */ "./src/assets/js/modules/adaptiveBlock.js");
/* harmony import */ var _modules_animate_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/animate.js */ "./src/assets/js/modules/animate.js");
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/form.js */ "./src/assets/js/modules/form.js");
/* harmony import */ var _modules_cookies_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/cookies.js */ "./src/assets/js/modules/cookies.js");
/* harmony import */ var _modules_user_leave_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/user-leave.js */ "./src/assets/js/modules/user-leave.js");
/* harmony import */ var _modules_masonry_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/masonry.js */ "./src/assets/js/modules/masonry.js");
/* harmony import */ var _modules_DocumentEvents_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/DocumentEvents.js */ "./src/assets/js/modules/DocumentEvents.js");
...
/******/ })()
;
//# sourceMappingURL=app.min.js.maps
