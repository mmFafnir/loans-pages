...
class Accordion {
  ...
  init() {
    ...
    this.title.addEventListener("click", () => {
      console.log(this._toggleClickHandler);
      this._toggleClickHandler();
    });
  }
...
class TextMore extends Accordion {
  ...
  openBody() {
    if (this.body.classList.contains("active")) {
      ...
      this.title.textContent = "Скрыть";
    } else {
      this.body.removeAttribute("style");
      this.title.textContent = "Читать больше";
    }
  }
}
...
/* harmony import */ var _modules_user_leave_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/user-leave.js */ "./src/assets/js/modules/user-leave.js");
